...
*/
	...
	strcat(pDescr, "\r\n");
	strcat(pDescr, "s=H.265 Video, streamed by the qddytt Media Server\r\n");
	strcat(pDescr, "i=test.h265\r\n");
   	strcat(pDescr, "t=0 0\r\n");	
   	strcat(pDescr, "a=tool:qddytt Streaming Media v2015.11.27\r\n");	
	strcat(pDescr, "a=type:broadcast\r\n");
	strcat(pDescr, "a=control:*\r\n");
	strcat(pDescr, "a=range:npt=0-\r\n");
	strcat(pDescr, "a=x-qt-text-nam:H.265 Video, streamed by the qddytt Media Server\r\n");	
